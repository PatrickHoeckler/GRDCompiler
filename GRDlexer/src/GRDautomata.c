...
char* GRDcode2string(enum GRDcode x) {
  switch (x)
  {
  ...
  case GRD_RBRACKET: return "RBRACKET";
  case GRD_LBRACKET: return "LBRACKET";
  case GRD_SEMICOLON: return "SEMICOLON";
  case GRD_COLON: return "COLON";
  case GRD_COMMA: return "COMMA";
  case GRD_STAR: return "STAR";
  case GRD_RPARENTHESIS: return "RPARENTHESIS";
  case GRD_LPARENTHESIS: return "LPARENTHESIS";
  case GRD_DOLLAR: return "DOLLAR";
  case GRD_GT: return "GT";
  case GRD_GTE: return "GTE";
  case GRD_LT: return "LT";
  case GRD_LTE: return "LTE";
  case GRD_DIF: return "DIF";
  case GRD_PLUS: return "PLUS";
  case GRD_MIN: return "MIN";
  case GRD_DIV: return "DIV";
  case GRD_L_REAL: return "L_REAL";
  case GRD_L_INT: return "L_INT";
  case GRD_L_STR: return "L_STR";
  case GRD_L_CHAR: return "L_CHAR";
  case GRD_CL: return "COMENTLINHA";
  case GRD_CB: return "COMENTBLOCO";
  case GRD_EMPTY: return "EMPTY";
  case GRD_ID: return "ID";
  case GRD_DOT: return "DOT";
  case GRD_DDOT: return "DDOT";
  case GRD_ERROR: return "ERROR";
  case GRD_NULL: return "NULL";
  default: return "N/A";
  }
}

enum GRDcode GRDstate2code(enum GRDstate x) {
  switch (x)
  {
  case GRD_ST_NULL: return GRD_NULL;
  ...
  default: return GRD_ERROR;
  }
}

enum GRDcode reservedWord(char *word) {
